...
**
**  Project/Product : MBU
**  Filename        : test_BR_LLSC_7_5.c
**  Author(s)       : David Purdie
**  Description     :
**      Implements BR_LLSC_7_5 business rule unit-tests.
**
**  Function(s)     :
...
static void setProduct(MYKI_TAControl_t *pMYKI_TAControl, int pIndex, int pType, int zoneLow, int zoneHigh)
{
    ...
    if (myki_br_GetCardProduct(pIndex, &pDirectory, NULL) >= 0)
    {
        ...
        {
            CsErrx("test_BR_LLSC_7_5 : setProduct::MYKI_CS_TAProductGet( %d ) failed", pIndex);
        }
    } else
    {
        CsErrx("test_BR_LLSC_7_5 : setProduct::myki_br_GetCardProduct( %d ) failed", pIndex);
    }
}
...
static void dumpZones(MYKI_BR_ContextData_t *pData)
{
    ...
    {
        CsVerbose("test_BR_LLSC_7_5 - Zone: %3d, Mask: %x, DirIndex: %d\n",
                zone,
...
static int runTest( MYKI_BR_ContextData_t *pData, MYKI_TAControl_t *pMYKI_TAControl, int rc, int bc, int inUse)
{
    ...
    */
    ...
    if ( rv != rc )
    {
        CsVerbose("test_BR_LLSC_7_5 - Unexpected exit code. Got:%d, Expected:%d\n", rv, rc );
        dumpZones(pData);
        return FALSE;
    }
    ...
    {
        CsVerbose("test_BR_LLSC_7_5 - Unexpected ByPassCode. Got:%d, Expected:%d\n", pData->ReturnedData.bypassCode, bc);
        dumpZones(pData);
        return FALSE;
    }
...
int test_BR_LLSC_7_5_001(MYKI_BR_ContextData_t *pData)
{
    ...
    */
    CsVerbose("+BR_LLSC_7_5 - Test with NULL data pointer");
    if (BR_LLSC_7_5(NULL) != RULE_RESULT_ERROR)
    {
        return FALSE;
    }
...
int test_BR_LLSC_7_5_006(MYKI_BR_ContextData_t *pData)
{
    ...
    **  Run the Test and examine the results
    */
    return runTest(pData, pMYKI_TAControl, RULE_RESULT_EXECUTED, 6, 1 );
}

/*==========================================================================*
**
**  test_BR_LLSC_7_5_007
**
**  Description     :
**      Expired Tariff Full Product Coverage
**      Unit-test Execute conditions.
...
int test_BR_LLSC_7_5_007(MYKI_BR_ContextData_t *pData)
{
    ...
    **  Run the Test and examine the results
    */
    return runTest(pData, pMYKI_TAControl, RULE_RESULT_BYPASSED, 8, 1 );
}

/*==========================================================================*
**
**  test_BR_LLSC_7_5_008
**
**  Description     :
**      Expired Tariff Full Product Coverage
**      Unit-test Execute conditions.
...
/*==========================================================================*
**
**  test_BR_LLSC_7_5_014
**
**  Description     :
**      Expired Tariff Full Product Coverage
**      Unit-test Execute conditions.
**              Partially covered and provisional product is a border product
**
**  Parameters      :
**      pData           [I/O]   BR context data
**
...
int test_BR_LLSC_7_5_014(MYKI_BR_ContextData_t *pData)
{
    ...
    **  Non-Zero product purchase value
    **  No Coverage
    **  Provisional product is a border product
    */
    CardImage1(pData);
    ...
    **  Run the Test and examine the results
    */
    return runTest(pData, pMYKI_TAControl, RULE_RESULT_EXECUTED, 6, 0 );
}
